...
var Designer = {
			...
			function c() {
				$(".panel_box").off().on("mousedown", function(s) {
					...
					$(document).bind("mouseup.create", function() {
                        ...
                        /*console.log(q[0].childNodes[1]);
                        console.log($('.text_canvas')[0],$(this));
                        $('.text_canvas')[0].onblur = function () {
							alert('asd');
                        };*/

                       /* console.log(q[0].childNodes[1]);
                        console.log(JSON.stringify(q));
                        console.log(q.attr("id"));*/

                        //console.log(q);
                        $('#' + l.id +' .text_canvas').onfocus = function () {
							//console.log("666");
                        };
	...
	op: {
                        ...
                        success : function (data) {
                            ...
                            if (a.name === 'rectangle'){
                            	for (var gg=0;gg<data.length;gg++){
                            		...
                            		for (var kk=0;kk<data[gg].length;kk++){
                            			if (kk==0){
                            				str = str + "<div class='col-sm-2' style='width: 11%'><b>"+data[gg][0]+":</b></div><div class='col-sm-10' style='padding: 0px'>";
										}else{
                            				str = str + "<label><input name='myRadio' type='radio' value='"+data[gg][kk]+"' />"+data[gg][kk]+"</label>&nbsp;&nbsp;"
										}
									}
									str = str + "</div></div>";
									bodyUp.append(str);
								}
							}else if (a.name === 'round'){
                                for (var jj=0;jj<data.length;jj++){
                                    bodyUp.append("<label><input name='myRadio' type='radio' value='"+data[jj]+"' />"+data[jj]+"</label>&nbsp;&nbsp;");
                                }
							}
                            $("input[name=myRadio]").each(function(){
                                $(this).click(function(){
                                	$.ajax({
										...
										error : function () {
                                            $('#bodyDown').empty().append("<p><b>属性加载失败！</b></p>")
                                        }
									});
		...
		canvasDraggable: function() {
			var a = $("#canvas_container");
			a.css("cursor", "url(/themes/default/images/cursor_hand.png) 8 8, auto");
